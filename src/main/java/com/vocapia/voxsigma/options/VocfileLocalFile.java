...
/**
 * Vocfile to submit to the REST API using file stored locally.
 */
public class VocfileLocalFile extends Vocfile implements LocalFileInterface {

    protected File local_file;

    public VocfileLocalFile(String local_path) throws FileNotFoundException {
