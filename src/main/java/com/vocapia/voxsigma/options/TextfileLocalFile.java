...
/**
 * Textfile to submit to the REST API using file stored locally.
 */
public class TextfileLocalFile extends Textfile implements LocalFileInterface {

    protected File local_file;

    public TextfileLocalFile(String local_path) throws FileNotFoundException {
